      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="bg-white rounded-xl shadow-lg p-8 max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-6">
            ...
            For emergency services, please call us directly.
          </p>
          <button
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Ready to start your roofing project? Get in touch with our expert team 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-blue-600 text-white px-6 py-4 rounded-lg hover:bg-blue-700 transition-colors duration-200 font-semibold flex items-center justify-center group"
                >
                  Send Message
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:info@eagleroofing.com" className="text-blue-600 hover:text-blue-700">
                ...
                <div className="space-y-3">
                  ...
                  <div className="mt-4 p-4 bg-red-50 rounded-lg">
                    ...
                    <p className="text-red-600 text-sm">
                      Call anytime for urgent roofing issues
                    </p>
                  </div>
                </div>
              </div>
